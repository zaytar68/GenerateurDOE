...
namespace GenerateurDOE.Migrations
{
    ...
    [Migration("20250919144649_AddTableMatieresEditFields")]
    partial class AddTableMatieresEditFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GenerateurDOE.Models.DocumentGenere", b =>
                {
                    ...
                    b.Property<bool>("EditTableMatieres")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("TableMatieresPersonnalisee")
                        .HasMaxLength(5000)
